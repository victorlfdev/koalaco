  ...
  return (
    <section id="contato" className="container" style={{ paddingBottom: "var(--section-pad)" }}>
      <Reveal as="div" className="cta-banner">
        ...
        <a href="https://wa.me/5511952093370?text=Olá! Vim pelo site KoalaCo. Gostaria de agendar um diagnóstico gratuito." className="btn btn-ghost" target="_blank" rel="noopener noreferrer">
